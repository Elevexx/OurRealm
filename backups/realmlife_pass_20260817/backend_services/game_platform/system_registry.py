...
ECONOMY_SEED = {
    "fire_power": {"label": "Fire Power", "kind": "platform_currency",
                   ...
                   "creature_rewards": {"creature_victory": 5, "boss_victory": 30, "capture": 10,
                                        "evolution": 15, "quest": 20, "achievement": 10,
                                        "region": 12, "multiplayer": 8, "event": 25,
                                        "daily": 15, "seasonal": 40,
                                        "difficulty_bonus_pct": {"easy": 0, "normal": 10, "hard": 25}},
                   "limits": {"daily_player_cap": 300, "claim_cooldown_s": 60},
                   "policy": {"burn_requires_confirmation": True,
                              "never_required_for_main_story": True,
