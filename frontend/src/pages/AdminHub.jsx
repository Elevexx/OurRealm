...
const CARDS = [
  ...
  },
  {
    ...
    description: "ORAi moderation — priority queue, trust scores, natural-language commands, bulk actions, appeals.",
    Icon: ShieldAlert,
    accent: "#FF5A5A",
    badge: "Support",
    roles: ["founder", "admin"],
  },
  {
    ...
    to: "/admin/moderation",
    title: "Moderation Center (legacy)",
    description: "AI flags, user reports, manual blur, audit log.",
    Icon: ShieldAlert,
    accent: "#F4A73B",
    badge: "Support",
    roles: ["founder", "admin"],
  ...
  },
  {
    ...
    description: "Main ORAi dashboard — AI providers, model routing, health, usage, jobs, costs and automation.",
    Icon: Sparkles,
    accent: "#C26BFF",
    badge: "Founder Only",
    roles: ["founder"],
  ...
  },
  {
    id: "gamemaker",
    to: "/admin/gamemaker",
    title: "OurRealm Game Maker",
    description: "Game Maker management — saved games, builds & jobs, engagement resources, ledger, runtimes, publishing and diagnostics.",
    Icon: Sparkles,
    accent: "#10E670",
    badge: "Founder Only",
    roles: ["founder"],
    statKey: null,
    footer: "🎮 Open Game Maker Admin",
  },
  {
    id: "portals",
    to: "/admin/portals",
