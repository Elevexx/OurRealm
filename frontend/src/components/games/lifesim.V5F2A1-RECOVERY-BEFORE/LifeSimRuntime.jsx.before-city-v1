...
import { createLifeAvatar } from "./lifeSimAvatar";
...
const DEFAULT_AVERY_AVATAR = {
  id: "av_streetwear",
  label: "Streetwear",
  modelUrl: "/api/media/models/fe59ed71ebde0f6ed51c393269bd7da7.glb",
  animationUrls: {
    idle: "/api/media/models/de89d838195e981b317fdc40a1a4eee0.glb",
    walk: "/api/media/models/2f1fe1efa8664eb9e1040aa896d397da.glb",
    run: "/api/media/models/1bc6fb23679170a047e6d25f3efff02c.glb",
    jump: "/api/media/models/caf26a5d45dc4b71fb921736eff373b2.glb",
    fall: "/api/media/models/e800378eccbe8c0511c405a24fa44bb1.glb",
    land: "/api/media/models/75cc3563d29144561437860672d91dc9.glb",
    greet: "/api/media/models/1f0b5c06aeb4e490043c433e1e45886d.glb",

    // RealmLife AAA Motion Pack A
    sit_down: "/api/media/models/33efee3c19c75925f5d3b0e31ec22bb4.glb",
    sit_idle: "/api/media/models/40dc7c75b25d8e2bbc6cb750622da1a5.glb",
    stand_up: "/api/media/models/83b9490897ccec3b19c744fb2850041f.glb",
    lie_down: "/api/media/models/8b660ce1ba67aaccec3c5724e74bc0fa.glb",
    sleep: "/api/media/models/4075ce21d999900d7c85c016c0b20aca.glb",
    wake_up: "/api/media/models/2153f3b1dc6e760de979dabc0df5a1d3.glb",
    talk: "/api/media/models/238d154636ea64b49248f995e2507013.glb",
    phone: "/api/media/models/89e5cb5314b6e491afec0b0dec6ec854.glb",
    drink: "/api/media/models/45aa7de86bc5c49204ff1ff02a10b181.glb",
    open_door: "/api/media/models/06ac4870b852cce736420bee0d91a0ec.glb",
  },
};
...
export default function LifeSimRuntime({ game, progress, onExit }) {
  ...
  useEffect(() => {
    ...
    const avatarCfg = {
      ...
      ...(game?.spec?.life_sim?.avatar || {}),
    };

    avatarCfg.animationUrls = {
      ...DEFAULT_AVERY_AVATAR.animationUrls,
      ...(
        game?.spec?.life_sim?.avatar
          ?.animationUrls || {}
      ),
  ...
  return (
    ...
    >
      ...
      >
        Click anywhere: walk · Explore house, yard, streets and neighboring buildings · WASD: walk · Shift: run · Q/E:
        rotate · Wheel: zoom
      </div>
