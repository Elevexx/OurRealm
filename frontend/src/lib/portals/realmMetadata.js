...
export const REALM_METADATA = [
  ...
  },
  {
    ...
    emoji: "🌱",
    description: "Config-driven Rainforest placeholder built via the reusable Realm template. Proves the pattern for future data-authored Realms.",
    longDescription:
      "The first Realm shipped purely through the Portals 1.4 TemplateRealm system. A single JavaScript config file (metadata + lighting + environment + spawn + portal + particles + props) is enough to plant a working Realm anchor — no bespoke class required. Use this as the reference template for every future Realm.",
    thumbnail: "linear-gradient(135deg, #052e1e 0%, #16a34a 55%, #a3e635 100%)",
    accent: "#22c55e",
    secondary: "#bbf7d0",
    supportedPlatforms: ["ar", "phone", "tablet"],
    requiredCapabilities: ["webxr:immersive-ar", "webxr:hit-test", "camera"],
    version: "1.4.0",
    status: REALM_STATUS.INTERNAL_TESTING,
    lastUpdated: "2026-02-07",
    notes: "Portals 1.4 · TemplateRealm reference. Rainforest-lite loads its scene from /lib/portals/realmTemplates/rainforest.js.",
    audioProfile: "ambient",
    lightingProfile: "daytime",
    weatherProfile: "clear",
    performanceLevel: "low",
    estimatedFps: "60fps on modern mobile",
    tags: ["template", "reference", "portals-1.4"],
    hasGameplay: true,
  },
  {
    id: "aquarium",
