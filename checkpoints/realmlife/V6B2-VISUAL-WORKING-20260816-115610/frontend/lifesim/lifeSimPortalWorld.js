...
export function buildRealmLifePortalWorld(
  ...
  // ========================================================
  // REALMLIFE V6B2 EXPANDED MOUNTAIN ENVELOPE
  //
  // Old world:
  // centerZ 45 / radius 145
  //
  // New city:
  // 100-home community + Downtown + Riverwalk + Station.
  // Mountains are now a distant cinematic horizon instead
  // of sitting inside the residential streets.
  // ========================================================
...
export function buildRealmLifeFounderEstate(
  ...
  for (
    ...
    platterCore.rotation.x =
      Math.PI / 2;


    platterCore.position.set(
      deckX,
      1.54,
      0
    );
  ...
  djBooth.userData.lifeObject =
    true;

  djBooth.userData.id =
    "realmlife-dj-booth";

  djBooth.userData.label =
    "RealmLife DJ Studio";

  djBooth.userData.actions = [
    {
      id:
        "dj_mixer",
