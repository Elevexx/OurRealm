  ...
  useEffect(() => {
    ...
    const monitorResidentMotion =
      (now) => {
        ...
        /*
         * Advance the equipped avatar AnimationMixer.
         *
         * setState() chooses Walking / Running, but Three.js
         * animations remain frozen on their bind frame unless
         * the mixer is advanced every render/motion frame.
         */
        residentAvatar
          ?.update?.(
            dt
