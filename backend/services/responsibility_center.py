...
ROLE_PERMISSIONS = {
    "owner":   {"edit_center", "invite_members", "remove_members", "manage_roles",
                ...
                "view_private_items",
                "view_units", "create_units", "edit_units", "archive_units",
                "manage_unit_members", "assign_unit_leaders", "view_private_units",
                "view_calendar", "create_events", "edit_any_event", "cancel_events",
                "invite_attendees", "manage_event_attendance", "view_private_events",
                "override_schedule_conflicts", "convert_student_task_to_assignment"},
    ...
    "manager": {"invite_members", "view_vault", "view_activity", "fund_vault",
                ...
                "manage_unit_members", "view_private_units",
                "view_calendar", "create_events", "cancel_events",
                "invite_attendees", "manage_event_attendance",
                "override_schedule_conflicts", "convert_student_task_to_assignment"},
