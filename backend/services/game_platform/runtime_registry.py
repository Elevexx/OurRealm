...
RUNTIME_FAMILY_SEED = {
    ...
    "turn_based_creature_rpg": _fam("Turn-Based Creature RPG", "rpg", "generatable",
                                    ["turn-based battles", "creatures", "party", "evolution", "quests", "overworld", "capture"]),
    ...
    "creature_collector": _fam("Creature Collector", "rpg", "generatable",
