...
DEFAULTS = [
    ...
    _s("documentary", "Cinematic Documentary", "Premium documentary storytelling", "premium documentary style, natural lighting, steady observational camera, authentic settings", "history, science, nature", "10+", "medium", "#3b6d5a", "#0e1f18"),
    ...
    _s("anime", "Anime", "Japanese animation aesthetic", "high-quality anime, cel shading, expressive eyes, dramatic speed lines, detailed backgrounds", "teens, gaming, story", "10+", "medium", "#ff5c8a", "#2b1055"),
    _s("manga", "Manga", "Black & white manga panels", "manga illustration, ink linework, screentone shading, dynamic panel-like compositions", "teens, story", "10+", "medium", "#dddddd", "#222222"),
    ...
    _s("oil_painting", "Oil Painting", "Classical painted look", "classical oil painting, visible brush strokes, rich impasto texture, museum quality", "art, history", "10+", "medium", "#7a5c3b", "#2b1d0e"),
    ...
    _s("fortnite", "Fortnite Inspired", "Vibrant stylized game art", "vibrant stylized battle-game art, exaggerated proportions, saturated colors, energetic outlines", "teens, gaming", "10+", "easy", "#7f5af0", "#2cb67d"),
    ...
    _s("realistic_3d", "Realistic 3D", "High-end 3D visualization", "high-end realistic 3D render, physically based materials, ray-traced lighting", "science, engineering", "10+", "hard", "#6d7b8d", "#22303c"),
    ...
    _s("steampunk", "Steampunk", "Brass gears & steam", "steampunk world, brass gears, steam pipes, Victorian machinery, warm copper tones", "history, engineering", "10+", "medium", "#c38e4e", "#3b2a1a"),
    ...
    _s("neon", "Neon", "Glowing neon energy", "glowing neon light aesthetic, dark backgrounds with vivid neon strokes and glow bloom", "music, tech", "10+", "easy", "#39ff14", "#7d12ff"),
    ...
    _s("infographic", "Infographic Style", "Data-forward visuals", "animated infographic style, charts, labeled callouts, clean data visualization, flat design", "business, statistics", "10+", "easy", "#06d6a0", "#118ab2"),
    _s("blueprint", "Blueprint Style", "Technical schematics", "technical blueprint style, white line schematics on blueprint blue, measurements and annotations", "engineering", "10+", "easy", "#caf0f8", "#03045e"),
